...
<<<<<<< HEAD
        h = self.extractor(x,x2)
=======
        h ,mydepth= self.extractor(x)
>>>>>>> b43e1a358b5853ffb749ac931c9cd97a6dccf862
...
<<<<<<< HEAD
    def predict(self, imgs, imgs_depth, sizes=None,visualize=False):
=======
...
=======
            img ,img_meaningless= preprocess(at.tonumpy(img),at.tonumpy(img))
