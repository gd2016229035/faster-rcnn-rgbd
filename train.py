...
from data.dataset import Dataset, TestDataset, inverse_normalize, inverse_normalize_depth
...
def eval(dataloader, faster_rcnn, test_num=10000):
    ...
    for ii, (imgs, img_depth, sizes, gt_bboxes_, gt_labels_, gt_difficults_) in tqdm(enumerate(dataloader)):
...
>>>>>>> b43e1a358b5853ffb749ac931c9cd97a6dccf862
    for epoch in range(opt.epoch):
        ...
        for ii, (img, img_depth, bbox_, label_, scale) in tqdm(enumerate(dataloader)):
